    ...
    <div class="content">
                    ...
                    <div class="card-header">
                        ...
                        <div class="tab-content mt-2 mb-3" id="pills-tabContent">
                            ...
                            <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                              <div class="card-body">
                                <form action="<?php echo base_url('superadmin/karyawan/update') ?>" method="POST">
                                <div class="row mt-3">
                                    <div class="col-md-6">
                                        <div class="form-group form-group-default">
                                            <label>First name</label>
                                            <input type="hidden" class="form-control" value="<?php echo $d->id_karyawan ?>" name="id_karyawan" placeholder="Address">
                                            <input type="text" class="form-control" name="nama_depan" placeholder="Name" value="<?php echo $d->nama_depan ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group form-group-default">
                                            <label>Last name</label>
                                            <input type="text" class="form-control" name="nama_belakang" placeholder="Name" value="<?php echo $d->nama_belakang ?>">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-6">
                                        <div class="form-group form-group-default">
                                            <label>Email</label>
                                            <input type="email" class="form-control" id="datepicker" name="email" value="<?php echo $d->email ?>" placeholder="Birth Date">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                     <div class="form-group form-group-default">
                                        <label>Phone number</label>
                                        <input type="text" class="form-control" value="<?php echo $d->no_hp ?>" name="no_hp" placeholder="Phone">
                                    </div>
                                </div>
                            ...
                            <div class="row mt-3">
                                <div class="col-md-4">
                                    <div class="form-group form-group-default">
                                       ...
                                       <input type="text" class="form-control" value="<?php echo $d->tempat_lahir ?>" name="tempat_lahir" placeholder="Phone">
                                   </div>
                               </div>
                               <div class="col-md-4">
                                <div class="form-group form-group-default">
                                 <label>Birth Date</label>
                                 <input type="date" class="form-control" id="datepicker" name="tgl_lahir" value="<?php echo $d->tgl_lahir ?>" placeholder="Birth Date">
                             </div>
                         </div>
                         <div class="col-md-4">
                            <div class="form-group form-group-default">
     ...
     <div class="row mt-3">
        <div class="col-md-12">
            <div class="form-group form-group-default">
                <label>Address</label>
                <input type="text" class="form-control" value="<?php echo $d->alamat ?>" name="alamat" placeholder="Address">
            </div>
        </div>
    </div>
    <div class="row mt-3">
       ...
       <div class="col-md-6">
        <div class="form-group form-group-default">
            ...
            <input type="text" class="form-control" name="no_identitas" placeholder="Name" value="<?php echo $d->no_identitas ?>">
        </div>
    </div>
</div>
