                                            ...
                                            <tr>
                                                <td>
                                                    <div class="flex-1 ml-3 pt-1">
                                                        <h5 class="text-uppercase fw-bold mb-1"><a href="<?php echo base_url('user/karyawan/detail/' . $d->id_karyawan) ?>" class="text-dark"><?php echo $d->nama_depan ?> <?php echo $d->nama_belakang ?></a></h5>
...
<!-- fitur bawaan error, tdk terpakai -->
<!-- <?php $no = 0;
