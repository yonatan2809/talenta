                        ...
                        <li class="nav-item dropdown hidden-caret">
                            ...
                            <ul class="dropdown-menu dropdown-user animated fadeIn">
                                ...
                                <li>
                                    ...
                                    <a class="dropdown-item" href="<?php echo base_url('superadmin/dashboard')  ?>"><i class="fas fa-key"></i>&nbsp; Account Setting</a>
                                    <div class="dropdown-divider"></div>
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse" id="forms">
                                <ul class="nav nav-collapse">
                                    <li>
                                        <a href="<?php echo base_url('superadmin/cuti')  ?>">
                         ...
                         <li class="nav-item">
                            <a href="<?php echo base_url('superadmin/payroll')  ?>">
                                ...
                                <ul class="nav nav-collapse">
                                    <li>
                                        <a href="<?php echo base_url('superadmin/jabatan')  ?>">
                                            <span class="sub-item">Job Position</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url('superadmin/divisi')  ?>">
                                            <span class="sub-item">Organization</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
